...
class TransactionTest < Minitest::Test
  ...
  def test_create_sepa_transaction
    stub_request(:post, 'https://api.2000charge.com/api/transactions').
        with(
  ...
  def test_retrieve_all_transactions
    stub_request(:get, 'https://api.2000charge.com/api/transactions/').
        with(
  ...
  def test_retrieve_transaction
    stub_request(:get, 'https://api.2000charge.com/api/transactions/trn_d12209838b').
        with(
            headers: {
                :authorization => "Basic #{Base64.encode64('test').gsub("\n", '')}",
                :content_type => 'application/json',
