...
class CustomerTest < Minitest::Test
  ...
  def test_create_customer
    stub_request(:post, 'https://api.2000charge.com/api/customers').
        with(
            body: '{'\
  ...
  def test_retrieve_all_customers
    stub_request(:get, 'https://api.2000charge.com/api/customers/').
        with(
  ...
  def test_retrieve_customer
    stub_request(:get, 'https://api.2000charge.com/api/customers/123').
        with(
            headers: {
                :authorization => "Basic #{Base64.encode64('test').gsub("\n", '')}",
                :content_type => 'application/json',
  ...
  def test_retrieve_customers_with_pagination
    stub_request(:get, 'https://api.2000charge.com/api/customers/?limit=3&offset=10').
        with(
            headers: {
                :authorization => "Basic #{Base64.encode64('test').gsub("\n", '')}",
                :content_type => 'application/json',
