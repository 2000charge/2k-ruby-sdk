...
class VoidTest < Minitest::Test
  ...
  def test_void_transaction
    stub_request(:post, 'https://api.2000charge.com/api/transactions/trn_41f1487/voids').
        with(
            body: hash_including(
                {
  ...
  def test_retrieve_void
    stub_request(:get, 'https://api.2000charge.com/api/transactions/trn_41f1487/voids/void_0a3f6b2').
        with(
            headers: {
                :authorization => "Basic #{Base64.encode64('test').gsub("\n", '')}",
                :content_type => 'application/json',
  ...
  def test_retrieve_all_voids
    stub_request(:get, 'https://api.2000charge.com/api/transactions/trn_41f1487/voids/').
        with(
            headers: {
                :authorization => "Basic #{Base64.encode64('test').gsub("\n", '')}",
                :content_type => 'application/json',
