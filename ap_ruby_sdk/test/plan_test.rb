...
class PlanTest < Minitest::Test
  ...
  def test_create_plan
    stub_request(:post, 'https://api.2000charge.com/api/plans').
        with(
            body: hash_including(
                {
                    name: 'Test'
  ...
  def test_retrieve_all_plans
    stub_request(:get, 'https://api.2000charge.com/api/plans/').
        with(
  ...
  def test_retrieve_plan
    stub_request(:get, 'https://api.2000charge.com/api/plans/pln_6507986').
        with(
            headers: {
                :authorization => "Basic #{Base64.encode64('test').gsub("\n", '')}",
                :content_type => 'application/json',
  ...
  def test_retrieve_plans_with_pagination
    stub_request(:get, 'https://api.2000charge.com/api/plans/?limit=3&offset=10').
        with(
            headers: {
                :authorization => "Basic #{Base64.encode64('test').gsub("\n", '')}",
                :content_type => 'application/json',
