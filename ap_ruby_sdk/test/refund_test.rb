...
class RefundTest < Minitest::Test
  ...
  def test_refund_transaction
    stub_request(:post, 'https://api.2000charge.com/api/transactions/trn_41f1487/refunds').
        with(
            body: hash_including(
                {
                    reason: 'FRAUD'
            ...
            headers: {
                ...
                :user_agent => "2000charge Ruby SDK v#{ApRubySdk::VERSION}"
            }
  ...
  def test_retrieve_refund
    stub_request(:get, 'https://api.2000charge.com/api/transactions/trn_41f1487/refunds/ref_0a3f6b2').
        with(
            headers: {
                :authorization => "Basic #{Base64.encode64('test').gsub("\n", '')}",
                :content_type => 'application/json',
  ...
  def test_retrieve_all_refunds
    stub_request(:get, 'https://api.2000charge.com/api/transactions/trn_41f1487/refunds/').
        with(
            headers: {
                :authorization => "Basic #{Base64.encode64('test').gsub("\n", '')}",
                :content_type => 'application/json',
